...
@pytest.fixture
def valid_contact_and_date_io() -> List[Tuple[str, str]]:
    """
    Fixture that returns a list of valid contact and date inputs and outputs.

    Returns:
        ``List[Tuple[str, str]]``
            A list of tuples containing a valid contact and date input and output.
    """
    return [
        ("Ipo", (datetime.today() + timedelta(days=1)).strftime("%d-%m-%Y")),
        ("Self", (datetime.today() - timedelta(days=1)).strftime("%d/%b/%Y")),
        ("Ipo", None),
    ]
...
def invalid_date_io() -> List[Tuple[str, str]]:
    """
    Fixture that returns a list of invalid date inputs and outputs.

    Returns:
        ``List[Tuple[str, str]]``
            A list of tuples containing an invalid date input and output.
    """
    return [
        ("IPo", "2022/01/01"),
        ("IPo", "2021"),
