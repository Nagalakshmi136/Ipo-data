...
from utils import ipo_watch, ipo_premium, gmp_today
from constants import IPO_WATCH_URL, IPO_PREMIUM_URL, GMP_TODAY_URL
...
soups = load_data([IPO_WATCH_URL,IPO_PREMIUM_URL]) 
ipo_watch_data = ipo_watch.get_data(soups[0])
ipo_premium_data = ipo_premium.get_data(soups[1],today_date)
...
# target = '"Ipo"'
contact_path = '//*[@id="pane-side"]/div[1]/div/div/div[1]/div/div/div/div[2]/div[1]'
...
input_field.send_keys(ipo_watch_data + Keys.ENTER)
